...
public class ChannelController {
    ...
    public ResponseEntity<?> getChannelInfo(@Valid @RequestBody YouTubeRequest request, HttpServletRequest httpRequest){
        ...
        try{
            ...
            logSearch("CHANNEL_INFO",request.getUrl(),httpRequest,(int)(System.currentTimeMillis()-startTime),true ,null);
            ...
            logSearch("CHANNEL_INFO",request.getUrl(),httpRequest,(int)(System.currentTimeMillis()-startTime),false,e.getMessage());
             return ResponseEntity.badRequest().body(response);
        }
    }

    private void logSearch(String searchType , String query , HttpServletRequest request,int responseTime , boolean success , String errorMessage){
        try{
